    ...
    <React.Fragment>
      <main className="w-[100vw] h-[100vh] bg-[url('../public/assets/images/fundo.png')] ">
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          <div className="w-[600px] h-[600px] bg-white mx-auto max-w-md py-8 px-10 shadow-2xl rounded-3xl max-[414px]:w-[320px] max-[414px]:h-[600px]	max-[360px]:w-[290px] max-[360px]:h-[640px]">
